...
export default function Page() {
  // Note: API Key check is now handled on the server/API route side, 
  // so we don't strictly need to check process.env.API_KEY on the client for the warning.
  // However, we can keep the UI clean.
      ...
      <footer className="bg-slate-900 text-slate-400 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs">
            ...
            <p className="mt-2 md:mt-0">Powered by Google Gemini API & Next.js</p>
          </div>
        </div>
      </footer>
    </div>
...
function PrinciplesSection({ principles }: { principles: any[] }) {
  'use client'; // This part needs state
